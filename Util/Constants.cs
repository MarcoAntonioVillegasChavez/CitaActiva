...
namespace CitaActiva.Util
{
    public class Constants
    {
        ...
        public const string AgenciasUrl = "https://pruebaspaquetes.autocomcube.mx/api/agencias/";
        ...
        public const string correoElectronico = "citaactiva@autocom.mx";
        public const string password = "Citaactiva01";

        //public const string correoElectronico = "marco.villegas@autocom.mx";
        //public const string password = "Temporals";
    }
}
